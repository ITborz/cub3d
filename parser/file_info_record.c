...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   recording_file_info.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: bkristen <bkristen@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/11 14:28:56 by bkristen          #+#    #+#             */
/*   Updated: 2022/10/11 17:36:04 by bkristen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	recording_file_info(char **split_file, t_cub *cub)
{
	...
	while (split_file[i])
	{
		...
		if (!(ft_strncmp(&split_file[i][j], "NO", 2)))
			...
			recording_color(&split_file[i][j], cub->textur.color_roof);
		i++;
	}
}
